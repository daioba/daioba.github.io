...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
      ...
      },{id: "news-two-papers-were-accepted-at-iclr-2026",
          ...
          description: "",
          section: "News",},{id: "news-gave-an-invited-talk-at-the-82nd-nagoya-nlp-seminar",
          title: 'Gave an invited talk at the 82nd Nagoya NLP Seminar',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/daioba", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=0HJ4NKsAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/dai0NLP", "_blank");
        },
      },{
      id: 'light-theme',
